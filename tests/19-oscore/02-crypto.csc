...
<simconf>
  ...
  <simulation>
    ...
    <motetype>
      ...
      <source>[CONFIG_DIR]/code-oscore/crypto-test.c</source>
      <commands>make -j crypto-test.cooja TARGET=cooja</commands>
  ...
  <plugin>
    ...
    <plugin_config>
      <scriptfile>[CONFIG_DIR]/js/01-oscore-context.js</scriptfile>
      <active>true</active>
    </plugin_config>
    <width>495</width>
    <z>0</z>
