...
uint8_t
get_seq_from_token(uint8_t *token, uint8_t token_len, uint32_t *seq)
{
...
uint8_t
set_seq_from_token(uint8_t *token, uint8_t token_len, uint32_t seq)
{
...
void
remove_seq_from_token(uint8_t *token, uint8_t token_len)
{
  token_seq_t *ptr = token_seq_store;
