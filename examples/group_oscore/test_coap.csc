...
<simconf>
  ...
  <simulation>
    ...
    <mote>
      <interface_config>
        ...
        <x>41.86399953904482</x>
        <y>60.37330160195845</y>
        <z>0.0</z>
      </interface_config>
      <interface_config>
    ...
    <mote>
      <interface_config>
        org.contikios.cooja.interfaces.Position
        <x>47.57706887252534</x>
        <y>53.21998783170104</y>
        <z>0.0</z>
      </interface_config>
      <interface_config>
        org.contikios.cooja.contikimote.interfaces.ContikiMoteID
    ...
    <mote>
      <interface_config>
        org.contikios.cooja.interfaces.Position
        <x>38.50203336257469</x>
        <y>88.29647718959616</y>
        <z>0.0</z>
      </interface_config>
      <interface_config>
        org.contikios.cooja.contikimote.interfaces.ContikiMoteID
  ...
  <plugin>
    ...
    <plugin_config>
      ...
      <viewport>7.060682263372931 0.0 0.0 7.060682263372931 -119.05526186588476 -318.37276435028815</viewport>
    </plugin_config>
    <width>400</width>
    <z>2</z>
    <height>400</height>
